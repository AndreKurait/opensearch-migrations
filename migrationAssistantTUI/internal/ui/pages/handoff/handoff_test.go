...
func TestAgentCmdDefault(t *testing.T) {
	t.Parallel()
...
func TestAgentCmdClaude(t *testing.T) {
	t.Parallel()
	require.Equal(t, "claude", agentCmd(wizard.State{}, "claude"))
}

func TestAgentCmdKiro(t *testing.T) {
	t.Parallel()
	require.Contains(t, agentCmd(wizard.State{}, "kiro-cli"), "@start")
}
