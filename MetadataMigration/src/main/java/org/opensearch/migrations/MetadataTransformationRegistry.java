...
public class MetadataTransformationRegistry {
    ...
    private static class TransformerConfigs {
        ...
        ContextResolution resolveContext(Version sourceVersion, Version targetVersion) {
            if (contextProvider != null) {
                ...
                return dynamic == null ? ContextResolution.skip() : ContextResolution.of(dynamic);
            }
    ...
    private static final class ContextResolution {
        ...
        private ContextResolution(boolean skip, String context) { this.skip = skip; this.context = context; }
        static ContextResolution skip() { return new ContextResolution(true, null); }
    ...
    private static String getAggregateJSTransformer(
        ...
        var rendered = transformerConfigs.stream()
            .map(c -> {
                ...
                return resolution.skip ? null : getJSTransform(c.getFilename(), resolution.context);
            })
